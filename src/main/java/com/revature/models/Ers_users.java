...
private Ers_user_roles user_roles_fk;
public Ers_users() {
	super();
	// TODO Auto-generated constructor stub
}
public Ers_users(int ers_user_id, String ers_username, String ers_password, String user_first_name,
		String user_last_name, String user_email, Ers_user_roles user_roles_fk) {
	super();
...
public Ers_users(String ers_username, String ers_password, String user_first_name, String user_last_name,
		String user_email, Ers_user_roles user_roles_fk) {
	super();
	this.ers_username = ers_username;
	this.ers_password = ers_password;
	this.user_first_name = user_first_name;
...
public String toString() {
	return "Ers_user [ers_user_id=" + ers_user_id + ", ers_username=" + ers_username + ", ers_password=" + ers_password
...
public int hashCode() {
	...
	result = prime * result + ((user_roles_fk == null) ? 0 : user_roles_fk.hashCode());
	return result;
}
@Override
public boolean equals(Object obj) {
	...
	if (user_last_name == null) {
		...
		return false;
	if (user_roles_fk == null) {
		if (other.user_roles_fk != null)
			return false;
	} else if (!user_roles_fk.equals(other.user_roles_fk))
		return false;
	return true;
}
...
public String getErs_username(String string) {
	return ers_username;
}
public void setErs_username(String ers_username) {
	this.ers_username = ers_username;
}
public String getErs_password(String string) {
	return ers_password;
}
public void setErs_password(String ers_password) {
	this.ers_password = ers_password;
}
public String getUser_first_name(String string) {
	return user_first_name;
}
public void setUser_first_name(String user_first_name) {
	this.user_first_name = user_first_name;
}
public String getUser_last_name(String string) {
	return user_last_name;
}
public void setUser_last_name(String user_last_name) {
	this.user_last_name = user_last_name;
}
public String getUser_email(String string) {
	return user_email;
}
public void setUser_email(String user_email) {
	this.user_email = user_email;
}
public Ers_user_roles getUser_roles_fk() {
	return user_roles_fk;
}
public void setUser_roles_fk(Ers_user_roles user_roles_fk) {
	this.user_roles_fk = user_roles_fk;
}
